              ...
              <div key={stage.name} className="mb-8 last:mb-0">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div
                      className={`relative h-16 bg-gradient-to-r ${stage.color} rounded-lg shadow-md flex items-center justify-between px-6 text-white transition-all duration-300 hover:shadow-lg`}
